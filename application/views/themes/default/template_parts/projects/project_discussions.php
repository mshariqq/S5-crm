...
<?php if(im_mobile()){ ?>
    ...
    if($project->settings->open_discussions == 1){ ?>
        ...
        <!-- old button -->
        <a href="#" onclick="new_discussion();return false;" class="btn btn-primary mtop5"><?php echo _l('new_project_discussion'); ?> <i class="mdi mdi-comment"></i> </a>
        <!-- Miles Stones -->
                                ...
                                <div class="row">
                                    <div class="col-10">
                                        <h6 class="font-weight-bold">
                                            <a class="text-primary" href="<?php echo site_url('clients/project/'.$project->id.'?group='.$group.'&discussion_id='.$discussion['id']); ?>">
                                                <?php echo $discussion['subject']; ?>
                                            </a>
                                        </h6>
                                        <p class="text-dark mb-0"><?php echo _l("Chats") ?> <b><?php echo $discussion['total_comments']; ?></b> </p>
                                        <p class="text-dark mb-0"><?php echo _l("Latest Activity") ?> <b>
                                                <?php
                                    ...
                                    <div class="col-2 d-flex justify-content-center align-items-center">
                                        <a href="<?php echo site_url('clients/project/'.$project->id.'?group='.$group.'&discussion_id='.$discussion['id']); ?>" class="btn btn-primary">
