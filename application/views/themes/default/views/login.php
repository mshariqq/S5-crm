...
<div class="col-12 mt-4">
   <div class="col-md-4 col-md-offset-4 text-center">
      <h4 class="text-uppercase mbot20 login-heading">
         <?php
   ...
   <div class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2">
      ...
      <div class="card">
         <div class="card-body">
            ...
            <div class="form-group">
               <button type="submit" class="btn btn-primary btn-block"><?php echo _l('clients_login_login_string'); ?> <i class="fe fe-user"></i> </button>
               <?php if (get_option('allow_registration') == 1) { ?>
                  <a href="<?php echo site_url('authentication/register'); ?>" class="btn btn-outline-primary btn-block"><?php echo _l('clients_register_string'); ?>
