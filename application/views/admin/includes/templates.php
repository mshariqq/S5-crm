...
<div class="media templates-wrapper <?php if($i == 0) echo 'mtop15' ?>">
    <div class="media-body">
        ...
        <button class="btn pull-right btn-primary mright5 " onclick="edit_template('<?php echo $rel_type ?>',<?php echo $template['id']; ?>, <?php echo $rel_id ?>);return false;"><i class="fa fa-pencil-square-o"></i></button>
        <?php } ?>
