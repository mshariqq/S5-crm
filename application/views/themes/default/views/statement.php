...
<div class="page-header">
      <h1 class="page-title"><?php echo _l('Account Statement'); ?></h1>
</div>

<div class="card section-statement bg-light text-dark">
   <div class="card-body">
      <h4 class="customer-statement-heading"><?php echo _l('customer_statement'); ?></h4>
      <div class="row">
         <div class="col-md-4">
            <div class="form-group">
               <select class="selectpicker form-control" name="range" id="range" data-width="100%" onchange="render_customer_statement();">
            ...
            <div class="col-md-8">
               <div class="text-right _buttons pull-right">
                  <a href="<?php echo site_url('clients/statement_pdf?from='.urlencode($from).'&to='.urlencode($to).'&print=true'); ?>" id="statement_print" target="_blank" class="btn btn-primary btn-with-tooltip mright5" data-toggle="tooltip" title="<?php echo _l('print'); ?>" data-placement="bottom">
                     <i class="fa fa-print"></i>
                  </a>
                  <a href="<?php echo site_url('clients/statement_pdf?from='.urlencode($from).'&to='.urlencode($to)); ?>" id="statement_pdf"  class="btn btn-danger btn-with-tooltip mright5" data-toggle="tooltip" title="<?php echo _l('view_pdf'); ?>" data-placement="bottom">
                              ...
                              <table class="table table-bordered table-striped">
                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td class="text-right text-primary"><?php echo app_format_money($statement['beginning_balance'], $statement['currency'], true); ?></td>
                                       <td></td>
                                       <td class="text-right text-indigo"><?php echo app_format_money($statement['beginning_balance'], $statement['currency'], true); ?></td>
                                    </tr>
                                    <?php
                               ...
                               <td class="text-right text-indigo font-weight-bold">
                                 <?php
                                 if(isset($data['invoice_id'])) {
                  ...
                  <tfoot class="statement_tfoot">
                     <tr>
                        <td colspan="3" class="text-right">
                           <b class="text-danger"><?php echo _l('balance_due'); ?></b>
                        </td>
                        <td class="text-right" colspan="2">
                           <b class="text-danger"><?php echo app_format_money($statement['balance_due'], $statement['currency']); ?></b>
                        </td>
                     </tr>
                  </tfoot>
               </table>
