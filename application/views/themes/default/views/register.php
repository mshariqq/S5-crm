...
<div class="col-md-6">
    <h1 class="text-uppercase register-heading mt-5 text-right"><?php echo _l('clients_register_heading'); ?></h1>
</div>
...
<div class="row">
    <div class="col-md-12 text-center">
        <div class="form-group">
            <button type="submit" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>" class="btn btn-primary"><?php echo _l('clients_register_string'); ?> <i class="fe fe-user"></i> </button>
        </div>
    </div>
</div>
<?php echo form_close(); ?>
