	...
	$(document).ready(function(){
		// $(".dataTables_info").addClass("tag bg-light p-2 text-primary");
		// $(".paginate_button").addClass("btn btn-outline-primary btn-sm");

		// get the current locatio url and find the anchor tag with that url
		// and add active class to its parent li
