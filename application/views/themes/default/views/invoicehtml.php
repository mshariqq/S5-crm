...
<div class="mtop15 preview-top-wrapper col-12 bg-white shadow">
   <div class="row">
      <div class="col-md-3">
         <div class="mbot30">
      ...
      <div class="container preview-sticky-container">
         <div class="row">
            <div class="col-md-12">
               ...
               <button type="submit" name="invoicepdf" value="invoicepdf" class="btn btn-primary pull-right action-button mtop5">
...
<div class="card mtop20 bg-light text-dark">
   <div class="card-body">
      <div class="col-md-10 col-md-offset-1">
         <div class="row mtop20">
            ...
            <div class="col-sm-6 text-right transaction-html-info-col-right">
               <span class="bold invoice-html-bill-to font-weight-bold"><?php echo _l('invoice_bill_to'); ?>:</span>
               ...
               <?php if ($invoice->include_shipping == 1 && $invoice->show_shipping_on_invoice == 1) { ?>
                  <span class="bold invoice-html-ship-to font-weight-bold"><?php echo _l('ship_to'); ?>:</span>
         ...
         <div class="row">
            <div class="col-md-12">
               <div class="table-responsive invoiceItemsTableCont">
                  <?php
            ...
            <div class="col-md-12 invoice-html-payments">
               ...
               if ($total_payments > 0) { ?>
                  <p class="bold mbot15 font-medium font-weight-bold"><?php echo _l('invoice_received_payments'); ?>:</p>
                  <table class="table table-hover invoice-payments-table table-bordered table-striped">
               ...
               <?php } else { ?>
                  <h5 class="bold pull-left font-weight-bold"><?php echo _l('invoice_no_payments_found'); ?></h5>
                  <div class="clearfix"></div>
                  ...
                  <div class="row">
                     ...
                     ?>
                        <div class="col-md-6 text-left">
                           <p class="bold mbot15 font-medium font-weight-bold"><?php echo _l('invoice_html_online_payment'); ?></p>
                           ...
                           <div class="form-group mtop25">
                              ...
                              <?php } else {
                                 echo '<h4 class="bold mbot25 font-weight-bold">' . _l('invoice_html_total_pay', app_format_money($invoice->total_left_to_pay, $invoice->currency_name)) . '</h4>';
                              }
                              ?>
                           </div>
                           <div id="pay_button">
                     ...
                     <?php if (found_invoice_mode($payment_modes, $invoice->id)) { ?>
                        <div class="invoice-html-offline-payments <?php if ($found_online_mode == true) {
                           ...
                           ?>
                                 <p class="bold font-weight-bold"><?php echo $mode['name']; ?></p>
                                 <?php if (!empty($mode['description'])) { ?>
                                    <div class="mbot15">
                                       <?php echo $mode['description']; ?>
                                    </div>
