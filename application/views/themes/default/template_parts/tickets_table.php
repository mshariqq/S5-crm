            ...
            <div class="card">
                <div class="card-body">
                    <h6 class="">
                      ...
                      <a class="" href="<?php echo site_url('clients/ticket/'.$ticket['ticketid']); ?>">
                        <?php echo $ticket['subject']; ?>
                      </a>
                    </h6>
                      <p class="mt-2">
                          <span class="label inline-block pull-left" style="background:<?php echo $ticket['statuscolor']; ?>">
...
<table class="table dt-table table-tickets table-hover table-striped mt-3 table-bordered" data-order-col="<?php echo (get_option('services') == 1 ? 7 : 6); ?>" data-order-type="desc">
