    ...
    <div class="col-md-4 ticket-info">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <p>
                                    <?php echo $field['name']; ?>: <span class="pull-right bold"><?php echo $cfValue; ?>
                                </span></p>
                                <?php } ?>
                            </div>
                        </div>
            ...
            <div class="col-md-8">
                ...
                <div class="card single-ticket-reply-area">
                    <div class="card-header d-md-flex justify-content-between">
                        <p class="pull-left mb-0"><?php echo _l('clients_ticket_single_add_reply_heading'); ?></p>
                        <button class="btn btn-indigo pull-right " type="submit" data-form="#ticket-reply" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>"><?php echo _l('ticket_single_add_reply'); ?></button>
                        ...
                        <div class="row col-12 justify-content-between">
                           <div class="col-md-8">
                            <div class="form-group">
                                <label for="attachment" class=""><?php echo _l('clients_ticket_attachments'); ?></label>
                                            <div class="input-group">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <?php 
                    echo _l("Opened with the following Description ");
                ?>
            </div>
            <div class="card-body <?php if($ticket->admin == NULL){echo 'client-reply';} ?>">
                <div class="row">
                    ...
                    <div class="col-md-9 bg-warning text-dark">
                        <br>
