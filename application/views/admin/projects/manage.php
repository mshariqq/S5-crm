    ...
    <div class="row">
      <div class="col-md-12">
            <div class="panel_s">
              ...
              <?php } ?>
              <a href="<?php echo admin_url('projects/gantt'); ?>" data-toggle="tooltip" title="<?php echo _l('project_gant'); ?>" class="btn btn-indigo text-light"><i class="mdi mdi-chart-pie" aria-hidden="true"></i></a>
              <div class="btn-group pull-right mleft4 btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('filter_by'); ?>">
                <button type="button" class="btn btn-indigo dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
               ...
               <div class="row mbot15">
                <div class="col-md-12">
                  <h4 class=""><?php echo _l('projects_summary'); ?></h4>
                  <?php
                  $_where = '';
                  if(!has_permission('projects','','view')){
                ...
                <div class="_filters _hidden_inputs col-12">
                  <?php
