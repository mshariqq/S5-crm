         ...
         <div class="panel_s mtop5">
            <div class="panel-body">
               <div class="_buttons">
                  ...
                  <a href="<?php echo admin_url('knowledge_base/article'); ?>" class="btn btn-primary mright5"><?php echo _l('kb_article_new_article'); ?></a>
                  <?php } ?>
                  <?php if($has_permission_edit || $has_permission_create){ ?>
                  <a href="<?php echo admin_url('knowledge_base/manage_groups'); ?>" class="btn btn-primary mright5"><?php echo _l('als_kb_groups'); ?></a>
                  <?php } ?>
