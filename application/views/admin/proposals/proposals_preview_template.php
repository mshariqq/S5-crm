            ...
            <div class="tab-content">
               ...
               <div role="tabpanel" class="tab-pane" id="tab_templates">
                  <div class="row proposal-templates">
                     <div class="col-md-12">
                        <button type="button" class="btn btn-primary" onclick="add_template('proposals',<?php echo $proposal->id ?? '' ?>);"><?php echo _l('add_template'); ?></button>
                        <hr>
                     </div>
                     <div class="col-md-12">
               ...
               <div role="tabpanel" class="tab-pane" id="tab_reminders">
                  <a href="#" data-toggle="modal" class="btn btn-primary" data-target=".reminder-modal-proposal-<?php echo $proposal->id; ?>"><i class="fa fa-bell-o"></i> <?php echo _l('proposal_set_reminder_title'); ?></a>
                  <hr />
