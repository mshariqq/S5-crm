      ...
      <div class="panel-body">
         ...
         <div class="row mtop10">
            ...
            <div class="col-md-6 _buttons text-right">
               ...
               <a href="<?php echo admin_url('invoices/list_invoices/'.$expense->invoiceid); ?>" class="btn mleft10 pull-right btn-primary"><?php echo format_invoice_number($invoice->id); ?></a>
               <?php } ?>
        ...
        <?php } ?>
         ...
         <div role="tabpanel" class="tab-pane" id="tab_reminders">
            <a href="#" data-toggle="modal" class="btn btn-primary" data-target=".reminder-modal-expense-<?php echo $expense->id; ?>"><i class="fa fa-bell-o"></i> <?php echo _l('expense_set_reminder_title'); ?></a>
            <hr />
