...
<?php echo form_open_multipart('clients/open_ticket',array('id'=>'open-new-ticket-form', 'class'=> 'col-12')); ?>
...
<div class="row">
   <div class="col-md-4">
      ...
      <div class="card">
         <div class="card-header text-uppercase open-ticket-subject">
   ...
   <div class="col-md-12 text-center mb-5">
      <div class="card">
         <div class="card-body">
            <p>
               <?php echo _l("We Hope you stay patient till you get a response!") ?>
            </p>
            <button type="submit" class="btn btn-success" data-form="#open-new-ticket-form" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>"><?php echo _l('Proceed & Create'); ?> <i class="mdi mdi-arrow-right"></i>  </button>
         </div>
      </div>
   </div>
</div>
