			...
			<div class="panel_s">
				<div class="panel-body">
					<div class="row col-12 pl-0">
						...
						<?php echo form_open(admin_url('projects/gantt'), ['method' => 'get', 'id' => 'ganttFiltersForm', 'class'=>'col-4']); ?>
						...
						?>
							<div class="col-md-3">
								<select class="selectpicker form-control" data-live-search="true" data-title="<?php echo _l('project_member'); ?>" name="member" data-width="100%">
									<option value=""></option>
