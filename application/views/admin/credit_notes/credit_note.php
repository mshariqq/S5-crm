  ...
  <div class="col-md-12 mtop15">
   <div class="panel-body bottom-transaction">
    ...
    <div class="btn-bottom-toolbar text-right">
     <button type="button" class="btn-tr btn btn-primary mleft10 credit-note-form-submit save-and-send transaction-submit">
       <?php echo _l('save_and_send'); ?>
     </button>
     <button class="btn-tr btn btn-primary mleft10 text-right credit-note-form-submit transaction-submit">
       <?php echo _l('submit'); ?>
     </button>
   </div>
 </div>
