                     ...
                     <div class="card">
                        <div class="card-body">
                           <h3 class="no-mbot bold pull-left">
                                 ...
                                 <a
                                    href="<?php echo site_url('clients/project/'.$project->id.'?group=edit_task&taskid='.$view_task->id); ?>">
                           ...
                           <span
                        class="task-single-status pull-right mright5 mtop15"><?php echo format_task_status($view_task->status); ?></span>
                        </div>
                     </div>
                    ...
                    <div class="row">
                                 ...
                                 <?php if ($view_task->status == Tasks_model::STATUS_COMPLETE) { ?>
                                       ...
                                       <?php if ($project->settings->view_task_total_logged_time == 1) { ?>
                                             <p class="no-margin">
                                               ...
                                               <span class="tag bg-primary"> <?php echo seconds_to_time_format($this->tasks_model->calc_task_total_time($view_task->id)); ?></span>
                                             </p>
                     ...
                     <div class="col-md-6">
                        <?php if ($project->settings->view_task_checklist_items == 1) { ?>
                           <?php if (count($view_task->checklist_items) > 0) { ?>
                              ...
                              <span
                                 class="task-checklist-indicator <?php if ($list['finished'] == 1) {
                                       echo 'text-success';
                                 } else {
                                       echo 'text-muted';
                                 } ?>"><i
                     ...
                     <div class="col-12">
                              ...
                              <div class="card">
                                 <div class="card-header">
                                    <h6>
                                       ...
                                       <small><?php echo _l('Team Members') ?></small>
                                 </h6>
                                 </div>
                                 <div class="card-body">
                                    <div class="row">
                                          ...
                                          foreach ($view_task->assignees as $assignee) {
                                             $_assignees .= '
                                             <div data-toggle="tooltip" class="pull-left mleft5 task-user tas-user-image-container " data-title="'.get_staff_full_name($assignee['assigneeid']).'">'
                        ...
                        <div class="col-md-6">
                           ...
                           <h4 class="bold font-weight-bold"><?php echo _l('task_view_description'); ?></h4>
                              ...
                              <?php if ($project->settings->view_task_attachments == 1) { ?>
                                    ...
                                    <div class="row task_attachments_wrapper">
                                       <div class="col-md-12">
                                          <div class="card">
                                             <div class="card-body">
                                             <h4 class="bold font-weight-bold"><?php echo _l('task_view_attachments'); ?></h4>
                                                   <div class="row">
                                                            <?php foreach ($view_task->attachments as $attachment) {
                                                               ob_start(); ?>
                                                            <div class="col-md-4 border bg-light text-dark task-attachment-col<?php if ($i > $show_more_link_task_attachments) {
                                                               echo ' task-attachment-col-more';
                                                            } ?>"
                                                               data-num="<?php echo $i; ?>"
                                                               <?php if ($i > $show_more_link_task_attachments) {
                                                               ...
                                                               <ul class="list-unstyled">
                                                                  <li class="mbot10 task-attachment">
                                                                        <div class="mbot10 pull-right task-attachment-user">
                                                                           <?php
                                                                     echo "<span class='text-muted'>"._l('project_file_uploaded_by')."</span>";
                                                                     echo "<br>";
                                                                     echo 
                        ...
                        <div class="col-md-6">
                                 <div class="card">
                                    ...
                                    <div class="card-body">
                                       ...
                                       <br>
                                       <button type="submit" class="btn btn-indigo mtop10 pull-right"
                                          data-loading-text="<?php echo _l('wait_text'); ?>"
                                          autocomplete="off"><?php echo _l('task_single_add_new_comment'); ?> <i class="mdi mdi-comment"></i> </button>
                                       <div class="clearfix"></div>
                                       <?php echo form_close();
                                       } ?>
                                    </div>
                                 ...
                                 margin-right: 20px;
                                    ...
                                    <?php
                                       ...
                                       <div class="mbot10 mtop10 task-comment" data-commentid="<?php echo $comment['id']; ?>"
                                          ...
                                          <img width="auto" height="70px" style="min-height: 70px; margin-right: 20px" src="<?php echo contact_profile_image_url($comment['contact_id']); ?>"
                                          ...
                                          <div class="media-body">
                                             ...
                                             <a href="#" onclick="edit_task_comment(<?php echo $comment['id']; ?>); return false;"
                                                   class="pull-right mright5 btn btn-info btn-sm">
