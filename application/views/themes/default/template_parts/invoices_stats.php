    ...
    <div class="col-md-3 invoices-stats-unpaid">
            ...
            <div class="col-md-8 stats-status">
                ...
                <div class="col-md-12">
                    <div class="progress no-margin">
                        <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo round($percent_open); ?>%" data-percent="<?php echo $percent_open; ?>">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3 invoices-stats-paid">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="progress no-margin">
                        <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo round($percent_paid) ?>%" data-percent="<?php echo $percent_paid; ?>">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3 invoices-stats-overdue">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="progress no-margin">
                        <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo round($percent_overdue) ?>%" data-percent="<?php echo $percent_overdue; ?>">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3 invoices-stats-partially-paid">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="progress no-margin">
                        <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo round($percent_not_paid_completely) ?>%" data-percent="<?php echo $percent_not_paid_completely; ?>">
                        </div>
                    </div>
                </div>
            </div>
