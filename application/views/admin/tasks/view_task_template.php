   ...
   <div class="row">
      <div class="col-md-8 task-single-col-left">
         ...
         <p class="no-margin pull-left" style="<?php echo 'margin-'.(is_rtl() ? 'left' : 'right').':5px !important'; ?>">
            <a href="#" class="btn btn-primary" id="task-single-mark-complete-btn" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>" onclick="mark_complete(<?php echo $task->id; ?>); return false;" data-toggle="tooltip" title="<?php echo _l('task_single_mark_as_complete'); ?>">
                        ...
                        <td>
                           <?php
                              if($timesheet['end_time'] !== NULL){
                                 ...
                                 data-content='<?php echo render_textarea('timesheet_note'); ?><button type="button" onclick="timer_action(this, <?php echo $task->id; ?>, <?php echo $timesheet['id']; ?>, 1);" class="btn btn-primary btn-xs"><?php echo _l('save'); ?></button>'
                                 class="text-danger"
         ...
         <div class="tasks-comments inline-block full-width simple-editor"<?php if(count($task->comments) == 0){echo ' style="display:none"';} ?>>
            ...
            <button type="button" class="btn btn-primary mtop10 pull-right hide" id="addTaskCommentBtn" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>" onclick="add_task_comment('<?php echo $task->id; ?>');" data-comment-task-id="<?php echo $task->id; ?>">
      ...
      <div class="col-md-4 task-single-col-right">
         ...
         <div id="newTaskReminderToggle" class="mtop15" style="display:none;">
            ...
            <button class="btn btn-primary btn-xs pull-right" type="submit" id="taskReminderFormSubmit">
            <?php echo _l('create_reminder'); ?>
            </button>
            <div class="clearfix"></div>
            <?php echo form_close(); ?>
