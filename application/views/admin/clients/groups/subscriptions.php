...
<a href="<?php echo admin_url('subscriptions/create?customer_id='.$client->userid); ?>" class="btn btn-primary mbot25<?php if($client->active == 0){echo ' disabled';} ?>"><?php echo _l('new_subscription'); ?></a>
<?php } ?>
