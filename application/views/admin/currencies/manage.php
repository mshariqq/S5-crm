			...
			<div class="col-md-12">
				<div class="panel_s">
					<div class="panel-body">
						<div class="_buttons">
							<a href="#" class="btn btn-primary pull-left" data-toggle="modal" data-target="#currency_modal"><?php echo _l('new_currency'); ?></a>
						</div>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="thousand_separator"><small class="req text-danger">* </small><?php echo _l('settings_sales_thousand_separator'); ?></label>
