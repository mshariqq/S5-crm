...
<hr class="hr-panel-heading" />
<button type="button" class="btn btn-primary pull-left mright10" onclick="conset_purpose(); return false;" data-toggle="tooltip" title="New Consent Purpose"><i class="fa fa-plus-square-o"></i></button>
