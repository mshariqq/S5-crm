...
<div class="page-header">
    <!-- ol breadcumb -->
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?php echo site_url('clients/dashboard'); ?>"> <i class="fa fa-home" aria-hidden="true"></i> <?php echo _l('Home') ?></a></li>
        <li class="breadcrumb-item active"><?php echo _l('clients_nav_contacts'); ?></li>
    </ol>
</div>

<div class="col-12">
    <h4 class="font-weight-bold"><?php echo _l("My Contacts") ?></h4>
</div>
